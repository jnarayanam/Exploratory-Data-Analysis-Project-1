...
# plot3 stored as a function, which used plot function to produce the required xy plot between day (DT column)
# and Sub_metering_1 (black), Sub_metering_2 (red), Sub_metering_3 (blue) (y axis).
...
# printing the plot3 on the screen 
plot3()

# # To store the plot3 as a .png file dev.copy function was used.
